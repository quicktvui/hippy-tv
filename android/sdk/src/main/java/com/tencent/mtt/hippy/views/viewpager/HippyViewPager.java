...
public class HippyViewPager extends ViewPager implements HippyViewBase {
  ...
  private void init(Context context,boolean enableTransformer) {
    ...
    if(enableTransformer) {
      setPageTransformer(new FadePageTransform());
      setAutoScrollCustomDuration(300);
    }
  ...
  public void setAutoScrollCustomDuration(int duration) {
    super.setAutoScrollCustomDuration(duration);
    if(duration < 1){
  ...
  //zhaopeng add
  public static final class FadePageTransform implements PageTransformer {

    private static final float MIN_ALPHA = 0;

    @Override
    public void transformPage(View page, float position) {
      LogUtils.v(TAG,"transformPage page:"+page+",position:"+position);
  ...
  public HippyViewPager(Context context, boolean isVertical,boolean enableTransform)
  {
    super(context, isVertical);
    init(context,enableTransform);
  }
