...
//		Log.d("leo", "ensureSuspensionState,count=" + count);
  ...
  protected View findNextFocusAfterFill(View focused, int focusDirection, RecyclerViewBase.Recycler recycler, RecyclerViewBase.State state){
    final FocusFinder ff = FocusFinder.getInstance();
    return ff.findNextFocus(mRecyclerView, focused, focusDirection);
  }
