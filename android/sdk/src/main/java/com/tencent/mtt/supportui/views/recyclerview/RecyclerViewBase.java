  ...
  protected void releaseGlowsForVertical()
  {
	...
	public void requestChildFocus(View child, View focused)
	{
		if (focused != null && mLayout != null && !mLayout.onRequestChildFocus(this, child, focused))
		{
			...
			requestChildRectangleOnScreen(child, mTempRect, false);
		}
	...
	protected void dispatchLayout()
	{
		...
		// cause a
		// prelayout step)
    final boolean dataChanged = mItemsAddedOrRemoved || mItemsChanged || mState.mStructureChanged;
    handleFocusBeforeLayout(mRecycler,mState,dataChanged);
    ...
    handleFocusAfterLayout(mRecycler, mState,dataChanged);
	}

  protected void handleFocusBeforeLayout(Recycler recycler, State state,boolean dataChanged){
//    Log.d("zhaopeng","+++handleFocusBeforeLayout state:"+state+" ,hasFocus:"+hasFocus());
    mLayout.handleFocusBeforeLayout(recycler,state,dataChanged);
  }

  protected void handleFocusAfterLayout(Recycler recycler, State state,boolean dataChanged){
//    Log.d("zhaopeng","---handleFocusAfterLayout state:"+state+" ,hasFocus:"+hasFocus());
    mLayout.handleFocusAfterLayout(recycler,state,dataChanged);
  }
	...
	public static abstract class LayoutManager
	{
		...
		public void detachAndScrapAttachedViews(Recycler recycler)
		{
			...
			for (int i = childCount - 1; i >= 0; i--)
			{
				...
				detachViewAt(i);
//				Log.d("zhaopeng ","detachAndScrapAttachedViews i:"+i+" v is:"+v);
		...
		protected void removeAndRecycleScrapInt(Recycler recycler, boolean remove, boolean recycle)
		{
			...
			for (int i = 0; i < scrapCount; i++)
			{
				...
				{
//				  if(scrap.hasFocus()) {
//            Log.e("zhaopeng ", "removeAndRecycleScrapInt index:" + i + " v is:" + scrap );
//          }else{
//            Log.d("zhaopeng ", "removeAndRecycleScrapInt index:" + i + " v is:" + scrap );
//          }
					if (remove)
					{
