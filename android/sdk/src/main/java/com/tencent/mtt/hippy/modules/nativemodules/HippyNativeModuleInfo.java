...
public class HippyNativeModuleInfo {
  ...
  private Provider<? extends HippyNativeModuleBase> mProvider;

  private Class<?> mClass;

  protected Map<String, HippyNativeMethod> mMethods;
  ...
  public static class HippyNativeMethod {
    ...
    protected Object[] prepareArguments(HippyEngineContext context, Type[] paramClss, HippyArray args,
        PromiseImpl promise) {
