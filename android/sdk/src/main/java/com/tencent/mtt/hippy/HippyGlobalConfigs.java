...
public class HippyGlobalConfigs {
  ...
  /**
   * 自定义HippyImageView的边框drawable代理
   */
  ...
  public HippyGlobalConfigs(HippyEngine.EngineInitParams params) {
    ...
    this.mBorderDrawableProvider = params.borderDrawableProvider;
    this.esBaseConfigManager = params.esBaseConfigManager;
  }
  ...
  private HippyGlobalConfigs(Context context,
                             ...
                             BaseBorderDrawableProvider<ConcurrentHashMap<Integer, BaseBorderDrawable>> borderDrawableProvider,
                             ESBaseConfigManager esBaseConfigManager) {
    ...
    this.mBorderDrawableProvider = borderDrawableProvider;
  ...
  public void to(HippyEngine.EngineInitParams params) {
    ...
    params.borderDrawableProvider = mBorderDrawableProvider;
    params.esBaseConfigManager = esBaseConfigManager;
  }
  ...
  public static class Builder {
    ...
    public Builder setBaseBorderDrawableProvider(BaseBorderDrawableProvider<ConcurrentHashMap<Integer, BaseBorderDrawable>> borderDrawableProvider) {
      this.mBorderDrawableProvider = borderDrawableProvider;
      return this;
    }

    public Builder setEsBaseConfigManager(ESBaseConfigManager esBaseConfigManager) {
      this.esBaseConfigManager = esBaseConfigManager;
      return this;
    }
    ...
    public HippyGlobalConfigs build() {
      ...
      if (mBorderDrawableProvider == null) {
        mBorderDrawableProvider = new BaseBorderDrawableFactory();
      }
      ...
      @SuppressWarnings("UnnecessaryLocalVariable") HippyGlobalConfigs configs = new HippyGlobalConfigs(
        ...
        mSoLoaderAdapter, mDeviceAdapter, mLogAdapter, mBorderDrawableProvider, esBaseConfigManager);
      return configs;
    }
  }
}
