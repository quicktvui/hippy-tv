...
public abstract class HippyEngineManagerImpl extends HippyEngineManager implements
  ...
  HippyEngineManagerImpl(EngineInitParams params, HippyBundleLoader preloadBundleLoader) {
    ...
    LibraryLoader.init(mGlobalConfigs.getContext(),
      mGlobalConfigs.getSharedPreferencesAdapter().getSharedPreferences(), mGlobalConfigs.getSoLoaderAdapter());
  }
  ...
  public HippyRootView loadModule(ModuleLoadParams loadParams, ModuleListener listener,
    ...
    if (loadParams.esBaseConfigManager != null){
      this.mGlobalConfigs.setEsBaseConfigManager(loadParams.esBaseConfigManager);
    }
    if (loadParams.baseBorderDrawableProvider!=null){
      this.mGlobalConfigs.setBorderDrawableProvider(loadParams.baseBorderDrawableProvider);
    }
  ...
  public void preloadModule(HippyBundleLoader loader) {
    preloadModule(loader, null);
  }

  @Override
  public void preloadModule(HippyBundleLoader loader, ModuleListener listener) {
    if (mEngineContext != null && mEngineContext.getBridgeManager() != null) {
      mEngineContext.getBridgeManager().runBundle(-1, loader, listener, null);
    }
  }
  ...
  private void notifyModuleLoaded(final ModuleLoadStatus statusCode, final String msg,
    ...
    Log.i("DebugExtend","load RootView statusCode : " + statusCode + " msg : " + msg + " hippyRootView : " + hippyRootView);
  ...
  private synchronized void restartEngineInBackground() {
    ...
    if(mOnEngineRestartListener != null) mOnEngineRestartListener.onRestart();
  }
