...
public class RenderManager {
  ...
  public void addCustomViewController(String name, HippyViewController controller, boolean lazy){
    mControllerManager.mControllerRegistry.addControllerHolder(name, new ControllerHolder(controller, lazy));
  }

  //add by zhaopeng  start
   ...
   */
  public void addCustomControllers(HippyAPIProvider hippyPackage) {
    this.addCustomControllers(Collections.singletonList(hippyPackage));
  }
  ...
  public void addCustomControllers(List<HippyAPIProvider> hippyPackages) {
    mControllerManager.addCustomControllers(hippyPackages);
  }
  //add by zhaopeng  end
